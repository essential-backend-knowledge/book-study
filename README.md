...
| 2 | Ch.4 | 외부 연동이 문제일 때 살펴봐야 할 것들 | |
| 2 | Ch.5 | 비동기 연동, 언제 어떻게 써야 할까 | |
| 3 | Ch.6 | 동시성, 데이터가 꼬이기 전에 잡아야 한다 | |
| 3 | Ch.7 | IO 병목, 어떻게 해결하지 | |
| 4 | Ch.8 | 실무에서 꼭 필요한 보안 지식 | |
| 5 | Ch.9 | 최소한 알고 있어야 할 서버 지식 | |
| 5 | Ch.10 | 모르면 답답해지는 네트워크 기초 | |
